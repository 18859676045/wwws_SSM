...
<body class="hold-transition skin-purple sidebar-mini">
			...
			<section class="content">
				...
				<div class="box box-primary">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" onclick="deleteProduct()"  title="删除">
							...
							<table id="dataList"
								...
								<form action="${pageContext.request.contextPath}/product/delete.do"  method="post">
									<c:forEach items="${productList}" var="product" varStatus="s">
										...
										<tr>
											<td><input name="ids" type="checkbox" id="${s.index}"  value="${product.id}"></td>
											<td>${product.id }</td>
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								总共 页，共14 条数据。 每页 <select class="form-control">
									<option>1</option>
									<option>2</option>
									<option>3</option>
									<option>4</option>
	...
	<script>
			...
			// var testGetArrvalue=arryObj[0];
			// //第三弹出整个checkbox数组中被索引的第2个元素的value值
			// alert(testGetArrvalue);
            //
		...
		$.ajax({
			...
			data:selectList, //数组通过JSON.stringify格式化
        ...
        <%--$("#delete").click(function () {--%>
                <%--if (confirm("您确定删除选中条目吗？")) {--%>
                    ...
                    <%--for (var i = 0; ids.length; i++) {--%>
                        <%--if (ids[i].checked) {--%>
                          <%--location.href="${pageContext.request.contextPath}/product/delete.do?ids="+ids;--%>
                            <%--break;--%>
                        <%--}--%>
                    <%--}--%>
                <%--}--%>
