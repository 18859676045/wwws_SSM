...
<link rel="stylesheet"
	...
	<%--<script>--%>
		<%--$("#delete").click(function () {--%>
			...
			<%--if (confirm("您确定要删除吗？")){--%>
                <%--location.href="${pageContext.request.contextPath}/product/delete.do?id="+${orders.id};--%>
			<%--}--%>
        <%--});--%>
	<%--</script>--%>
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<form action="${pageContext.request.contextPath}/product/delete.do" id="form">
								<tbody>
									<c:forEach items="${pageInfo.list}" var="orders">

										<tr>
											<td><input name="ids" id="${orders.id}" type="checkbox"></td>
											<td>${orders.id }</td>
		...
		$("#delete").click(function () {
			if (confirm("您确定删除选中条目吗？")){
			 location.href="${pageContext.request.contextPath}/orders/"
                ...
                location.href="${pageContext.request.contextPath}/orders/findAll.do"
            }
        });
